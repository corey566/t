...
return [
    ...
    'hcm_loyalty_discount_help' => 'Enter loyalty discount amount for this customer (fixed amount)',
    ...
    'enable_reward_points' => 'Enable Reward Points',
    'enable_reward_points_help' => 'Enable reward points system for customers',
    'reward_points_redemption' => 'Reward Points Redemption',
    ...
    'enable_hcm_loyalty' => 'Enable HCM Loyalty',
    'enable_hcm_loyalty_discount' => 'Enable HCM Loyalty Discount',
    'enable_hcm_loyalty_discount_help' => 'Enable HCM Loyalty discount feature for this business location',
    'hcm_loyalty_settings' => 'HCM Loyalty Settings',
    'hcm_loyalty_settings_help' => 'Configure HCM (Havelock City Mall) loyalty discount settings for your business locations',
    'hcm_loyalty' => 'HCM Loyalty',
    'hcm_loyalty_help' => 'HCM Loyalty discount is independent of regular discounts and reward points',
    'hcm_loyalty_enabled_locations' => 'Enable HCM Loyalty for Locations',
    'hcm_loyalty_locations_help' => 'Select business locations where HCM loyalty discount should be available',
    'hcm_loyalty_api_config_info' => 'To use HCM Loyalty, you need to configure API credentials for each selected location.',
    'configure_hcm_api_credentials' => 'Configure HCM API Credentials',
    'hcm_loyalty_discount_behavior' => 'Discount Behavior',
