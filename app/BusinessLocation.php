...
class BusinessLocation extends Model
{
    ...
    /**
     * Get API credentials for this location
     */
    ...
    /**
     * Get credentials for a specific mall
     */
    public function getCredentialsForMall($mallCode)
    {
        return $this->credentials()->where('mall_code', $mallCode)->where('is_active', true)->first();
    }
}