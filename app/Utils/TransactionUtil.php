...
class TransactionUtil extends Util
{
     ...
     * @return object
     */
    public function createSellTransactionWithLines($business_id, $input, $invoice_total, $user_id)
    {
        $transaction = $this->createSellTransaction($business_id, $input, $invoice_total, $user_id);
        //Add lines
        $this->createOrUpdateSellLines($transaction->id, $input['products'], $input['location_id'], false, null, [], true);
