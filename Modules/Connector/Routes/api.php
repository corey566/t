...
use Modules\Connector\Http\Controllers\Api\PurchaseController;

Route::middleware('auth:api', 'timezone')->prefix('connector/api')->group(function () {


    //yassin
    Route::resource('units', Modules\Connector\Http\Controllers\Api\UnitController::class);

    Route::resource('brands', Modules\Connector\Http\Controllers\Api\BrandController::class);

    Route::resource('taxonomies', Modules\Connector\Http\Controllers\Api\TaxonomyController::class);
