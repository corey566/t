...
class InstallController extends Controller
{
    ...
    {
        $this->module_name = 'gallface';
        $this->appVersion = config('gallface.module_version');
        $this->module_display_name = 'Gallface';
    }
    ...
    public function index()
    {
        ...
        $action_url = action([\Modules\Gallface\Http\Controllers\InstallController::class, 'install']);
        $intruction_type = 'uf';
        $action_type = 'install';
    ...
    public function install()
    {
        try {
            ...
            Artisan::call('module:migrate', ['module' => 'Gallface', '--force' => true]);
            Artisan::call('module:publish', ['module' => 'Gallface']);
            System::addProperty($this->module_name.'_version', $this->appVersion);

            DB::commit();

            $output = ['success' => 1,
                'msg' => 'Gallface module installed succesfully',
            ];
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['success' => 1,
                'msg' => 'Gallface module updated Succesfully to version '.$this->appVersion.' !!',
            ];
