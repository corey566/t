		...
		<table class="table table-condensed">
			...
			<tr>
				...
				<td>
					...
					<span class="tw-text-base md:tw-text-lg tw-font-semibold" id="rp_redeemed_amount_text">@if(empty($edit) || !isset($transaction) || empty($transaction))0@else{{@num_format($transaction->rp_redeemed_amount)}}@endif</span>
				</td>
				@endif
